...
const BASE_URL = "https://recipe-finder-api-3h6z.onrender.com/api/v1/recipe"
    ...
    try {
      ...
      switch (activeEndpoint) {
        ...
        case "7":
          ...
          break
        case "8":
          endpoint = `summary/id/${recipeId}`
          break
        case "9":
          endpoint = `instructions/id/${recipeId}`
          break
      }
          ...
          <Card>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {(activeEndpoint === "3" || activeEndpoint === "8" || activeEndpoint === "9") && (
                  <Input
                    type="text"
